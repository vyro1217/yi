import { WeakLabelBatcher, WeakLabelEntry } from '../src/utils/WeakLabelBatcher';
import fs from 'fs';
...
(async () => {
    ...
    // Enqueue less than batch, wait for timer flush
    ...
    // Enqueue to trigger batchSize flush
    ...
    // Test shutdown flushes remaining
    await rmOut();
    batcher.enqueue(entries[0]);
